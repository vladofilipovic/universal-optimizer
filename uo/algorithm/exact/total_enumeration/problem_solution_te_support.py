...
class ProblemSolutionTeSupport(Generic[R_co,A_co], metaclass=ABCMeta):
    ...
    @abstractmethod
    def reset(self, problem:TargetProblem, solution:TargetSolution[R_co,A_co], optimizer:Algorithm)->None:
        """
    ...
    @abstractmethod
    def progress(self, problem:TargetProblem, solution:TargetSolution[R_co,A_co], optimizer:Algorithm)->None:
        """
    ...
    @abstractmethod
    def can_progress(self, problem:TargetProblem, solution:TargetSolution[R_co,A_co], optimizer:Algorithm)->bool:
        """
    ...
    @abstractmethod
    def overall_number_of_evaluations(self, problem:TargetProblem, solution:TargetSolution[R_co,A_co], optimizer:Algorithm)->int:
        """
