...
from opt.single_objective.teaching.max_function_1_variable_problem.command_line import default_parameters_cl
from opt.single_objective.teaching.max_function_1_variable_problem.command_line import parse_arguments
...
from opt.single_objective.teaching.max_function_1_variable_problem.max_function_1_variable_problem_solver import \
        MaxFunctionOneVariableProblemSolver
...
def main():
    ...
    try:
        ...
        problem = MaxFunctionOneVariableProblem.from_input_file(input_file_path=input_file_path,
        ...
        if parameters['algorithm'] == 'variable_neighborhood_search':
            ...
            if solution_type=='int':
                ...
                solution:MaxFunctionOneVariableProblemBinaryIntSolution = \
                        MaxFunctionOneVariableProblemBinaryIntSolution(
            ...
            solver:MaxFunctionOneVariableProblemSolver = MaxFunctionOneVariableProblemSolver.\
