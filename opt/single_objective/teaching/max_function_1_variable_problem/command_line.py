""" 
The :mod:`~opt.single_objective.teaching.max_function_1_variable_problem.command_line` module is used for obtaining execution parameters for execution of the optimizers for max ones problem.
"""
import sys
