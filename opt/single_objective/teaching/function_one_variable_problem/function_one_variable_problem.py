...
FunctionOneVariableProblemElements = NamedTuple('FunctionOneVariableProblemElements', 
            [('expression',str), 
            ('domain_low',float), 
            ('domain_high',float)]
        )
...
class FunctionOneVariableProblem(TargetProblem):
    ...
    def __load_from_file__(cls, file_path:str, data_format:str)->int:
        ...
        if data_format=='txt':
                ...
                if len(data)>=3:
                    return FunctionOneVariableProblemElements(data[0], float(data[1]), float(data[2]))
                else:
    ...
    def from_input_file(cls, input_file_path:str, input_format:str):
        ...
        """
        params:FunctionOneVariableProblemElements = FunctionOneVariableProblem.__load_from_file__(input_file_path, 
                input_format)
