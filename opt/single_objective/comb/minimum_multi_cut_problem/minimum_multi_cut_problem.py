...
class MinimumMultiCutProblem(Problem):
    ...
    Methods:
        __init__(graph: nx.Graph, source_terminal_pairs: list): Initializes a new instance of the MinimumMultiCutProblem class.
        ...
        from_input_files(graph_file_path: str, source_terminal_pairs_file_path: str): Creates a new MinimumMultiCutProblem instance when the input file and input format are specified.
        __copy__() -> MinimumMultiCutProblem: Internal copy of the MinimumMultiCutProblem problem.
        copy() -> MinimumMultiCutProblem: Copy the MinimumMultiCutProblem problem.
        ...
        string_rep(delimiter: str, indentation: int = 0, indentation_symbol: str = '', group_start: str = '{', group_end: str = '}') -> str: String representation of the MinimumMultiCutProblem instance.
        __str__() -> str: String representation of the MinimumMultiCutProblem structure.
        __repr__() -> str: Representation of the MinimumMultiCutProblem instance.
        __format__() -> str: Formatted MinimumMultiCutProblem instance.
    """
    
    def __init__(self, graph:nx.Graph, source_terminal_pairs:list[tuple[int,int]])->None:
        """
        Create new `MinimumMultiCutProblem` instance
        ...
        if not isinstance(graph, nx.Graph):
            raise TypeError('Parameter \'graph\' for  MinimumMultiCutProblem should be \'nx.Graph\'.')
        if not isinstance(source_terminal_pairs, list):
            raise TypeError('Parameter \'source_terminal_pairs\' for  MinimumMultiCutProblem should be \'list\'.')
        super().__init__(name="MinimumMultiCutProblem", is_minimization=True, is_multi_objective=False)
        self.__graph = graph
    ...
    def from_graph_and_source_terminal_pairs(cls, graph:nx.Graph, source_terminal_pairs:list):
        """
        Additional constructor. Create new `MinimumMultiCutProblem` instance when graph and source_terminal_pairs are specified
    ...
    @classmethod
    def from_input_files(cls, graph_file_path: str, source_terminal_pairs_file_path: str)->'MinimumMultiCutProblem':
        """
        Additional constructor. Create new `MinimumMultiCutProblem` instance when input file and input format are specified
        ...
        """
        result:tuple = MinimumMultiCutProblem.__load_from_file__(graph_file_path, source_terminal_pairs_file_path)
    ...
    def __copy__(self)->'MinimumMultiCutProblem':
        """
        Internal copy of the `MinimumMultiCutProblem` problem

        :return: new `MinimumMultiCutProblem` instance with the same properties
        :rtype: `MinimumMultiCutProblem`
        """
        pr = deepcopy(self)
        return pr

    def copy(self)->'MinimumMultiCutProblem':
        """
        Copy the `MinimumMultiCutProblem` problem
    ...
    def string_rep(self, delimiter:str, indentation:int=0, indentation_symbol:str='', group_start:str ='{', 
        group_end:str ='}')->str:
        """
        String representation of the `MinimumMultiCutProblem` instance
