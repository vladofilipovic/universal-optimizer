...
class OnesCountMaxProblemIntSolution(Solution[int,str]):
    ...
    def __copy__(self):
        """
        Internal copy of the `OnesCountMaxProblemIntSolution`

        :return: new `OnesCountMaxProblemIntSolution` instance with the same properties
        :rtype: OnesCountMaxProblemIntSolution
        """
        sol = deepcopy(self)
        return sol
    ...
    def copy(self):
        """
        Copy the `OnesCountMaxProblemIntSolution`
