...
class SetCoveringProblemBitArraySolution(Solution[BitArray,str]):
    ...
    def __init__(self, random_seed:Optional[int]=None, 
        ...
        """
        Create new `SetCoveringProblemBitArraySolution` instance
        """
    ...
    def __copy__(self)->'SetCoveringProblemBitArraySolution':
        """
        Internal copy of the `SetCoveringProblemBitArraySolution`

        :return: new `SetCoveringProblemBitArraySolution` instance with the same properties
        :rtype: SetCoveringProblemBitArraySolution
        """
        sol = super().__copy__()
    ...
    def copy(self)->'SetCoveringProblemBitArraySolution':
        """
        Copy the `SetCoveringProblemBitArraySolution`
