...
class FunctionOneVariableMaxProblemBitArraySolution(Solution[BitArray,float]):
    ...
    def obtain_feasible_representation(self, problem:FunctionOneVariableMaxProblemMax)->BitArray:
    ...
    def init_from(self, representation:BitArray, problem:FunctionOneVariableMaxProblemMax)->None:
