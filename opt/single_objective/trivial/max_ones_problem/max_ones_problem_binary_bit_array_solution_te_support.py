...
class MaxOnesProblemBinaryBitArraySolutionTeSupport(ProblemSolutionTeSupport[BitArray]):
    ...
    def __init__(self)->None:
        """
        Create new `MaxOnesProblemBinaryBitArraySolutionTeSupport` instance
        """
        self.__bit_array_counter = None

    def __copy__(self):
        """
        Internal copy of the `MaxOnesProblemBinaryBitArraySolutionTeSupport`

        :return: new `MaxOnesProblemBinaryBitArraySolutionTeSupport` instance with the same properties
        :rtype: `MaxOnesProblemBinaryBitArraySolutionTeSupport`
        """
        sol = deepcopy(self)
        return sol
    ...
    def copy(self):
        """
        Copy the `MaxOnesProblemBinaryBitArraySolutionTeSupport` instance
    ...
    def reset(self, problem:MaxOnesProblem, solution:MaxOnesProblemBinaryBitArraySolution, optimizer:Algorithm)->None:
        """
    ...
    def string_rep(self, delimiter:str, indentation:int=0, indentation_symbol:str='', group_start:str ='{', 
        ...
        :rtype: str
        """        
        return 'MaxOnesProblemBinaryBitArraySolutionTeSupport'
