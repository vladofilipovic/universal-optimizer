...
class TestVnsOptimizerProperties(unittest.TestCase):
    ...
    def test_evaluations_max_should_be_equal_as_in_constructor(self):
        self.assertEqual(self.vns_optimizer.finish_control_mock.evaluations_max, self.evaluations_max)

    def test_iterations_max_should_be_equal_as_in_constructor(self):
        self.assertEqual(self.vns_optimizer.finish_control_mock.iterations_max, self.iterations_max)
    ...
    def test_seconds_max_should_be_equal_as_in_constructor(self):
        self.assertEqual(self.vns_optimizer.finish_control_mock.seconds_max, self.seconds_max)
