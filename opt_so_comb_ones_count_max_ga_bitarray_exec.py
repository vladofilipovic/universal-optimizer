...
def main():
        ...
        ga_crossover_support:GaCrossoverSupportRepresentationBinaryBitArray[str]= \
                GaCrossoverSupportRepresentationBinaryBitArray[str](crossover_probability=0.95)
        ga_mutation_support:GaMutationSupportRepresentationBinaryBitArray = \
                GaMutationSupportRepresentationBinaryBitArray[str](mutation_probability=0.0005)
