...
class TestOnesCountProblemMaxVnsBinaryIntSolutionLsbi(unittest.TestCase):
    
    @classmethod
    def setUpClass(cls):
        print("setUpClass TestIntegrationOnesCountProblemMaxVnsBinaryIntSolutionLsbi\n")
    ...
    def tearDownClass(cls):
        print("\ntearDownClass TestIntegrationOnesCountProblemMaxVnsBinaryIntSolutionLsbi")
